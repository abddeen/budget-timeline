...
export default function FullTable({ visible, loans }) {
  ...
  return (
    <div className="rounded-[10px] border border-border overflow-hidden">
      <button
        onClick={() => setOpen((v) => !v)}
        className="w-full py-3 px-4 bg-surface-alt border-none cursor-pointer flex items-center justify-between"
      >
        <span className="text-[10px] font-semibold tracking-[1.5px] uppercase text-text-dim">
